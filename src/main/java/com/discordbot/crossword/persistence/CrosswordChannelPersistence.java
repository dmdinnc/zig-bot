package com.discordbot.crossword.persistence;


import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.SerializationFeature;
import com.discordbot.crossword.types.CrosswordChannelInfo;
...
public class CrosswordChannelPersistence {
    ...
    public List<String> getTrackingChannels(String serverId) {
        ...
        for (CrosswordChannelInfo info : serverChannelMap.get(serverId)) {
